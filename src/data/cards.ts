export interface Card {
  id: string;
  phase: 1 | 2 | 3;
  type: 'topic' | 'action' | 'game'; // 话题 | 互动 | 特殊
  title: string;
  content: string;
...
export const PUNISHMENTS: Punishment[] = [
  { id: 'pun-1', type: 'drink', text: '两人各自端起酒杯，深情对视并喝下一小口（或果汁、饮料）。' },
  { id: 'pun-2', type: 'truth', text: '诚实回答对方：最近一次你在什么时候对我的身体或笑容动了小心思？' },
  { id: 'pun-3', type: 'dare', text: '握住对方的手，用小拇指在对方的手掌心轻轻画三个圆圈。' },
  { id: 'pun-4', type: 'drink', text: '认罚者需双手环抱对方，在对方背后盲写一个字，让对方猜，猜错则一起喝一口。' },
  { id: 'pun-5', type: 'truth', text: '如果你能拥有对方的一个秘密特异功能，你希望是什么？' },
  { id: 'pun-6', type: 'dare', text: '用额头轻轻贴着对方额头保持 8 秒，期间双方闭上眼。' },
  { id: 'pun-7', type: 'drink', text: '喂对方喝一口水或酒。必须用最宠溺的方式。' },
  { id: 'pun-8', type: 'truth', text: '老实交待：你觉得对方今晚穿的哪一件衣服或者发型最好看？为什么？' }
];
